Shader "Zaroa/CustomizableGrid(Alpha)" {
	Properties {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			_alpha = ((((_BaseColor.a * (1 - colBaseP) + (colBaseP * _BasePatternColor.a))*
					(1 - colCGrid) + (colCGrid * _CenterGridColor.a))*
					(1 - colCLine) + (colCLine * _CenterLineColor.a)) *
					(1 - colEdge) + (colEdge * _EdgeColor.a)) *
					(1 - colText) + (colText * _TextColor.a);
